...
DBT_PROJECT_DIR = os.getenv('DBT_PROJECT_DIR_FINANCE') # DBT_PROJECT_DIR = /dh_datastack_dbt/dh_datastack
...
DBT_MANIFEST_FILEPATH = "/home/gunther/dh_datastack_dbt/dh_datastack_finance/target/manifest.json"
DBT_MODEL_RUN = "model.dh_datastack_finance.int_finance__product_sales" #"model.dh_datastack.daily_product_sales" #"model.dh_datastack.int_finance__product_sales" #"model.dh_datastack.stg_dh_shop__customers"

with DAG(
    dag_id='dbt_dh_datastack_finance',
