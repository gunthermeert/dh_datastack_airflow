...
DBT_MODEL_RUN = os.getenv('DBT_MODEL_RUN') #"model.dh_datastack.daily_product_sales" #"model.dh_datastack.int_finance__product_sales" #"model.dh_datastack.stg_dh_shop__customers"
