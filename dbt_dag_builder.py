...
with DAG(
    ...
    dag_parser = DbtDagParser(
        ...
        dbt_model_run="model.dh_datastack.stg_dh_shop__customers", #"model.dh_datastack.daily_product_sales" #"model.dh_datastack.int_finance__product_sales" #"model.dh_datastack.stg_dh_shop__customers"
    )
